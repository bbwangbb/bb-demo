...
public class RedisUtil {
     ...
     * set key val ex nx
     */
    public Boolean setExNx(String key, Object value, Long time) {
     ...
     * @return void
     * @author guohaibin
     * @date 2020-10-28 10:24:00
     */
    public void del(Cursor<String> cursor) {
